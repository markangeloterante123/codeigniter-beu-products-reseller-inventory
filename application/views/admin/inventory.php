                  ...
                  for(i=0; i<data.length; i++){
                    if(data[i].qty == 0){
                        ...
                        '<tr>'+
                          ...
                          '<td>'+
                            '<a href="<?php echo base_url(); ?>pages/admin2/item_his/'+data[i].img_id+'/'+data[i].name_of_item+'" class="btn btn-default"><i class="fas fa-folder-open"></i></a> '+
                            ...
                            '<a href="javascript:void(0)"  title="Edit Item" class="btn btn-warning edit_item" data-id="'+data[i].img_id+'"><i class="fas fa-edit"></i></a> '+
