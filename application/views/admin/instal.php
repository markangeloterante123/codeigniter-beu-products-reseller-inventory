                ...
                var html = '';
                  for(i=0; i<data.length; i++){
                          html += 
                            ...
                            '<a href="javascript:void(0)" data-item_id="'+data[i].item_id+'" data-img_id="'+data[i].img_id+'" data-name="'+data[i].name_of_item+' '+data[i].size+' Base Price: '+data[i].base_price+'" data-resseller="'+data[i].resseller_price+'" data-base="'+data[i].base_price+'" class="btn btn-success addcart" title="Add-Cart"><i class="fas fa-shopping-cart"></i></a>'+
                            '</td>'+
                            '</tr>'
                           ;
                    }
        ...
        function item_retail(){
          var id = $("input[name='user_id']").val();
              $.ajax({
                ...
                success: function (data) {
                  var html = '';
                   var ressel = '<a style="width: 25%;" href="javascript:void(0)" class="btn btn-info retail"><h2><i class="fas ion-android-playstore"></i> Retail</h2></a> <a style="width: 25%;" id="resel" href="javascript:void(0)" class="btn btn-default reseller"><h2><i class="fas ion-social-dropbox"></i> Re-Seller</h2></a>';
        ...
        function reseller(){
          var id = $("input[name='user_id']").val();
              $.ajax({
                ...
                success: function (data) {
                  var html = '';
                  var ressel = '<a style="width: 25%;" href="javascript:void(0)" class="btn btn-default retail"><h2><i class="fas ion-android-playstore"></i> Retail</h2></a> <a style="width: 25%;" id="resel" href="javascript:void(0)" class="btn btn-success reseller"><h2><i class="fas ion-social-dropbox"></i> Re-Seller</h2></a>';
